...
use crate::repos::s3_repo::DigitalOceanSpacesRepo;
...
async fn main() {
    ...
    let digital_ocean_spaces_repo = DigitalOceanSpacesRepo::new("some-region", "".to_string())
        .await
    ...
    let accessions_service = AccessionsService {
        ...
        digital_ocean_spaces_repo: Arc::new(digital_ocean_spaces_repo),
    };
